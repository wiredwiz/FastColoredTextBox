...
namespace FastColoredTextBoxNS.Types
{
   ...
   public partial class TextSelectionRange : IEnumerable<Place>
   {
      ...
      /// <param name="options">Options for regex</param>
      ...
      public TextSelectionRange GetFragment(Style style, bool allowLineBreaks)
      {
         ...
         while (r.GoLeftThroughFolded())
         {
            ...
            if (r.Start.iChar < tb.GetLineLength(r.Start.iLine))
               if (tb[r.Start].GetStyleIndex(style) == -1)
               {
      ...
      public bool ReadOnly
      {
         get
         {
            ...
            if (IsEmpty)
            {
               ...
               foreach (StyledChar c in Chars)
                  if (c.ReadOnly)//found char with ReadonlyStyle
                     return true;
         ...
         set
         {
            ...
            ReadOnlyStyle readonlyStyle = tb.DefaultReadOnlyStyle;
